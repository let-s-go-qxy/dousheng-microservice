...
type User struct {
	...
	FavoriteCount int32  `protobuf:"varint,7,opt,name=favorite_count,json=favoriteCount,proto3" json:"favorite_count,omitempty"` // 用户喜欢作品数
...
var file_user_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x22, 0xef, 0x01, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x65, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0d, 0x66,
	...
	0x6e, 0x22, 0x2b, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x41, 0x76, 0x61, 0x74, 0x61, 0x72, 0x52, 0x65,
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x32, 0x93, 0x02, 0x0a, 0x0b,
	0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3b, 0x0a, 0x08, 0x55,
	...
	0x00, 0x12, 0x3e, 0x0a, 0x09, 0x47, 0x65, 0x74, 0x41, 0x76, 0x61, 0x74, 0x61, 0x72, 0x12, 0x16,
	0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x47, 0x65, 0x74, 0x41, 0x76, 0x61, 0x74, 0x61, 0x72, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x17, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x47, 0x65,
...
var file_user_proto_goTypes = []interface{}{
	...
	(*GetAvatarRequest)(nil),     // 7: user.GetAvatarRequest
	(*GetAvatarResponse)(nil),    // 8: user.GetAvatarResponse
}
var file_user_proto_depIdxs = []int32{
	...
	7, // 4: user.UserService.GetAvatar:input_type -> user.GetAvatarRequest
	2, // 5: user.UserService.UserInfo:output_type -> user.UserInfoResponse
	4, // 6: user.UserService.UserLogin:output_type -> user.UserLoginResponse
	6, // 7: user.UserService.UserRegister:output_type -> user.UserRegisterResponse
	8, // 8: user.UserService.GetAvatar:output_type -> user.GetAvatarResponse
...
type UserService interface {
	...
	GetAvatar(ctx context.Context, req *GetAvatarRequest) (res *GetAvatarResponse, err error)
}
