...
func (x *RelationActionRequest) GetContent() string {
	if x != nil {
		return x.Content
	}
	return ""
...
var file_message_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x89, 0x01, 0x0a, 0x15, 0x52, 0x65,
	...
	0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0x58, 0x0a, 0x16, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f,
	...
	0xb7, 0x01, 0x0a, 0x0e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x00, 0x12, 0x56, 0x0a, 0x11, 0x50, 0x6f, 0x73, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1e, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
...
var file_message_proto_goTypes = []interface{}{
	...
	(*RelationActionRequest)(nil),  // 3: message.RelationActionRequest
	(*RelationActionResponse)(nil), // 4: message.RelationActionResponse
}
var file_message_proto_depIdxs = []int32{
	...
	3, // 2: message.MessageService.PostMessageAction:input_type -> message.RelationActionRequest
	1, // 3: message.MessageService.GetMessageList:output_type -> message.MessageChatResponse
	4, // 4: message.MessageService.PostMessageAction:output_type -> message.RelationActionResponse
...
type MessageService interface {
	...
	PostMessageAction(ctx context.Context, req *RelationActionRequest) (res *RelationActionResponse, err error)
}
