...
func (x *FeedRequest) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.LatestTime, offset, err = fastpb.ReadInt32(buf, _type)
	return offset, err
}
...
func (x *FeedResponse) fastReadField4(buf []byte, _type int8) (offset int, err error) {
	x.NextTime, offset, err = fastpb.ReadInt32(buf, _type)
	return offset, err
}

func (x *FeedResponse) fastReadField5(buf []byte, _type int8) (offset int, err error) {
	x.State, offset, err = fastpb.ReadInt32(buf, _type)
	return offset, err
}
...
func (x *PublishVideoCountRequest) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_PublishVideoCountRequest[number], err)
}

func (x *PublishVideoCountRequest) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.UserId, offset, err = fastpb.ReadInt64(buf, _type)
	return offset, err
}

func (x *PublishVideoCountResponse) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_PublishVideoCountResponse[number], err)
}

func (x *PublishVideoCountResponse) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.PublishVideoCount, offset, err = fastpb.ReadInt32(buf, _type)
	return offset, err
}
...
func (x *VideoInfoRequest) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_VideoInfoRequest[number], err)
}
...
func (x *VideoInfoResponse) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_VideoInfoResponse[number], err)
}

func (x *VideoInfoResponse) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	var v Video
	offset, err = fastpb.ReadMessage(buf, _type, &v)
	if err != nil {
		return offset, err
...
func (x *FeedRequest) fastWriteField1(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt32(buf[offset:], 1, x.LatestTime)
	return offset
}
...
func (x *FeedResponse) fastWriteField4(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt32(buf[offset:], 4, x.NextTime)
	return offset
}

func (x *FeedResponse) fastWriteField5(buf []byte) (offset int) {
	if x.State == 0 {
		return offset
	}
	offset += fastpb.WriteInt32(buf[offset:], 5, x.State)
	return offset
}
...
func (x *User) fastWriteField10(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt32(buf[offset:], 10, x.WorkCount)
	return offset
}
...
func (x *User) fastWriteField11(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt32(buf[offset:], 11, x.FavoriteCount)
	return offset
}
...
func (x *PublishVideoCountRequest) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *PublishVideoCountRequest) fastWriteField1(buf []byte) (offset int) {
	if x.UserId == 0 {
		return offset
	}
	offset += fastpb.WriteInt64(buf[offset:], 1, x.UserId)
...
func (x *PublishVideoCountResponse) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *PublishVideoCountResponse) fastWriteField1(buf []byte) (offset int) {
	if x.PublishVideoCount == 0 {
		return offset
	}
...
func (x *VideoInfoRequest) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *VideoInfoResponse) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *VideoInfoResponse) fastWriteField1(buf []byte) (offset int) {
	if x.VideoInfo == nil {
		return offset
	}
...
func (x *FeedRequest) sizeField1() (n int) {
	...
	n += fastpb.SizeInt32(1, x.LatestTime)
	return n
}
...
func (x *FeedResponse) sizeField4() (n int) {
	...
	n += fastpb.SizeInt32(4, x.NextTime)
	return n
}

func (x *FeedResponse) sizeField5() (n int) {
	if x.State == 0 {
		return n
	}
	n += fastpb.SizeInt32(5, x.State)
	return n
}
...
func (x *User) sizeField10() (n int) {
	...
	n += fastpb.SizeInt32(10, x.WorkCount)
	return n
}
...
func (x *User) sizeField11() (n int) {
	...
	n += fastpb.SizeInt32(11, x.FavoriteCount)
	return n
}
...
func (x *PublishVideoCountRequest) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *PublishVideoCountRequest) sizeField1() (n int) {
	if x.UserId == 0 {
		return n
	}
	n += fastpb.SizeInt64(1, x.UserId)
...
func (x *PublishVideoCountResponse) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *PublishVideoCountResponse) sizeField1() (n int) {
	if x.PublishVideoCount == 0 {
		return n
	}
	n += fastpb.SizeInt32(1, x.PublishVideoCount)
	return n
}
...
func (x *VideoInfoRequest) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *VideoInfoResponse) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *VideoInfoResponse) sizeField1() (n int) {
	if x.VideoInfo == nil {
		return n
	}
...
var fieldIDToName_PublishVideoCountRequest = map[int32]string{
	1: "UserId",
}
