...
var file_video_proto_rawDesc = []byte{
	...
	0x64, 0x73, 0x32, 0xff, 0x02, 0x0a, 0x0c, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x53, 0x65, 0x72, 0x76,
	...
	0x73, 0x65, 0x22, 0x00, 0x42, 0x1a, 0x5a, 0x18, 0x64, 0x6f, 0x75, 0x73, 0x68, 0x65, 0x6e, 0x67,
...
var file_video_proto_depIdxs = []int32{
	...
	6,  // 3: video.VideoService.PublishVideo:input_type -> video.PublishActionRequest
	4,  // 4: video.VideoService.PublishList:input_type -> video.PublishListRequest
	8,  // 5: video.VideoService.PublishVideoCount:input_type -> video.PublishVideoCountRequest
	0,  // 6: video.VideoService.GetFeedList:input_type -> video.FeedRequest
	10, // 7: video.VideoService.GetPublishIds:input_type -> video.PublishIdsRequest
	7,  // 8: video.VideoService.PublishVideo:output_type -> video.PublishActionResponse
	5,  // 9: video.VideoService.PublishList:output_type -> video.PublishListResponse
	9,  // 10: video.VideoService.PublishVideoCount:output_type -> video.PublishVideoCountResponse
	1,  // 11: video.VideoService.GetFeedList:output_type -> video.FeedResponse
	11, // 12: video.VideoService.GetPublishIds:output_type -> video.PublishIdsResponse
